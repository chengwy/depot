class Product < ActiveRecord::Base
  ...
  BOOK_TYPES = [ "IT", "story" , "math" ,"language","science" ,"Arts & Photography" , "Children's Books" ,"Comics & Graphic ","History","Health, Fitness & Dieting","Law","Professional & Technical","Romance"]
